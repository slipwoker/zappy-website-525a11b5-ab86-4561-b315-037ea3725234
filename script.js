        ...
        contactForm.addEventListener('submit', function(e) {
            ...
            if (isValid) {
                ...
                setTimeout(() => {
                    ...
                    successMsg.style.cssText = 'color: #28a745; padding: 1rem; margin-top: 1rem; text-align: center; font-weight: 500;';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '525a11b5-ab86-4561-b315-037ea3725234',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '525a11b5-ab86-4561-b315-037ea3725234';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '525a11b5-ab86-4561-b315-037ea3725234';
